...
PROMPT = (
    ...
    "- comida: SOLO alimentos o bebidas envasados claramente visibles: enlatados, arroz, pasta, harina, granos, aceite, leche, jugos.\n"
    ...
    "- otros: objetos que NO sean comida, ropa, calzado, medicina, higiene ni limpieza. Ej: balón/pelota deportiva, juguetes, electrónicos (router, teléfono, cargador, cable), herramientas, electrodomésticos, útiles escolares, recipientes vacíos.\n\n"
    ...
    "IMPORTANTE: NO inventes ni asumas que es comida. Solo usa 'comida' si ves claramente un alimento o su envase con etiqueta de alimento. "
    "Un balón, un aparato electrónico, un juguete o una herramienta SIEMPRE es 'otros'. "
    "En 'subcategoria' escribe el nombre real del objeto que ves (ej: balón de baloncesto, router, cargador).\n\n"
